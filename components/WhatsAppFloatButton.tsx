...
export default function WhatsAppFloatButton() {
  return (
    <a
      ...
      className="fixed left-5 bottom-5 z-50 flex items-center justify-center w-11 h-11 bg-[#25D366] text-white shadow-lg hover:bg-[#1EBE57] active:bg-[#1EBE57] transition-colors duration-300"
    >
