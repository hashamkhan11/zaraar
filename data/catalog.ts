...
export const catalog: BrandCategory[] = [
  {
    ...
    groups: [
      ...
      //PP Single Tone Chain 
      {
        ...
        description:
          "The PP Single Tone Chain collection pairs a polished all-silver stainless steel case and integrated chain bracelet with four distinct dial personalities. From the cool calm of Ice Blue to the deep authority of Deep Blue, and from Pearl White to Midnight Black — each shares the same premium build, automatic movement, luminous markers, and date display. One watch family, four moods.",
        features: [
          "Movement : Quartz",
        ...
        variants: [
          {
            ...
            name: "Deep Blue",
            swatch: "#1E3D6B",
            cardImage: "/products/pp/single-tone/deep-blue/1.webp",
            images: [
          ...
          },
          {
            ...
            name: "Ice Blue",
            swatch: "#8EC9D8",
            cardImage: "/products/pp/single-tone/ice-blue/1.webp",
            images: [
          ...
          },
          {
            ...
            swatch: "#E8E8E8",
            swatchBorder: true,
            cardImage: "/products/pp/single-tone/white/1.webp",
            images: [
          ...
          },
          {
            ...
            name: "Midnight Black",
            swatch: "#1A1A1A",
            cardImage: "/products/pp/single-tone/black/1.webp",
            images: [
        ...
        variants: [
          {
            ...
            name: "Classic Black",
            swatch: "#1A1A1A",
            cardImage: "/products/pp/leather-strap/black/1.webp",
            images: [
          ...
          },
          {
            ...
            name: "Classic Brown",
            swatch: "#7B4B2A",
            cardImage: "/products/pp/leather-strap/brown/1.webp",
            images: [
...
export const LEGACY_REDIRECTS: Record<string, string> = {
  "watch-ice-blue":      "/product/pp-single-tone/ice-blue",
  "watch-deep-blue":     "/product/pp-single-tone/deep-blue",
  "watch-classic-brown": "/product/pp-leather-strap/brown",
  "watch-classic-black": "/product/pp-leather-strap/black",
  "tissot-quartz-blue":  "/product/tst-single-tone/silver",
};
